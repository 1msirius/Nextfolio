...
```
<Image
  src="/og-social-card.png"
  alt="Nextfolio Social Cardt"
  unoptimized
  width={640}
  height={500}
  priority
...
Nextfolio uses a custom [callout component](https://github.com/1msirius/Nextfolio/blob/main/app/components/mdx.tsx#L62) to render important information in MDX posts.
