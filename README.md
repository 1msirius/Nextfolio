...
- **Dynamic Feed Generation**: Automatic dynamic [Atom](https://nextfolio-template.vercel.app/atom.xml) and [JSON](https://nextfolio-template.vercel.app/feed.json) feeds.
