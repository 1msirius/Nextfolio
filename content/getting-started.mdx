...
Update your site metadata and social links in **app/config.ts** file. These constants are used throughout the application for SEO, feeds, and Open Graph.
...
export const metaData = {
  ...
  description:
    "A clean, fast, & simple portfolio template built with Next.js, Vercel, & Tailwind CSS for optimal performance.", // Update with your site description
};
...
Your portfolio is equipped with SEO, [RSS](/feed.xml), [Atom](/atom.xml), and [JSON](/feed.json) feeds, as well as analytics. Nextfolio is fully customizable, allowing you to add features as needed.
